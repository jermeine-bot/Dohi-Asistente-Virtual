...
export default function AppointmentAssistantScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <AppHeader title="Asistente de Cita" showLogo={true} onBack={() => router.back()} />
      ...
      >
        {/* Dohi Helper Banner */}
        <View style={styles.dohiTipCard}>
          <DohiCharacter variant="avatar" size={54} />
          <View style={styles.dohiTipTextCol}>
            <AppText variant="sm" weight="bold" color={colors.navy}>
              Consejo de Dohi
            </AppText>
            <AppText variant="xs" color={colors.textSecondary}>
              Tu cita virtual está confirmada. Conéctate 5 minutos antes para probar tu audio y cámara.
            </AppText>
          </View>
        </View>
